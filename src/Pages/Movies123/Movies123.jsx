...
import './Movies123.scss'

export default function Movies123() {
    return (
        <div className="container1">
            <div className="movie-logo-mid">
                <div className="logo-container">
                    <NavLink className="link" to={'/home'}><img src="https://upload.wikimedia.org/wikipedia/commons/c/c8/Movies_123movies.png" alt="logo" /></NavLink>
                </div>
            </div>
